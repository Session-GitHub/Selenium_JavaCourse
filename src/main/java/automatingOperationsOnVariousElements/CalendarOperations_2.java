...
public class CalendarOperations_2 {

    static String requiredDay = "5";
    static String requiredMonth = "june";
    static String requiredYear = "2022";
    static WebDriver driver;
    static int implicitlyWait = 50;
    static int pageloadWait   = 60;
    static Date expectedDates;
    static Date currentDates;
    ...
    public static void main(String[] str) throws InterruptedException {
        ...
        //conversion of dates for comparison
        String currentDate = currentDateAndTime();
        String expectedDate = requiredDay + "-" + requiredMonth + "-" + requiredYear;

        try {
            expectedDates = new SimpleDateFormat("dd-MMMM-yyyy" , Locale.ENGLISH)
                    .parse(expectedDate);

            currentDates = new SimpleDateFormat("dd-MMMM-yyyy" , Locale.ENGLISH)
                    .parse(currentDate);
        ...
        if (expectedDates.compareTo(currentDates) == 0) {
            ...
            //now, we will use while loop for click on next until we don't get the required date
